...
begin
  Result := NextObjId;
  FObjectCount := Result;
  GrowCapacity(FObjects, FObjectCapacity, FObjectCount, SizeOf(Integer), 16384);
end;
...
initialization
  ...
  begin
    ...
    KeyWords := '';
    Creator := '';///
    ///CS_ProductTitleStr + ' v' + IntToStr(RLibCommercialVersion) +
///      '.' + IntToStr(RLibReleaseVersion) + RLibCommentVersion + ' \251 ' + CS_CopyrightStr;
    Producer := '';
  end;
